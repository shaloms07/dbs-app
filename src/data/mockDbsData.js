...
const DBS_RECORDS = {
  ...
  MH12SC7788: {
    ...
    challanStatus: 'Clear',
    tpLoading: 0,
    purpose: 'Mumbai scooter paired with a family car on the same mobile number',
    violations: [
      {
        date: '2026-01-17',
        type: 'Wrong Parking',
  ...
  MH34UV4444: {
    ...
    challanStatus: 'Pending',
    tpLoading: 600,
    purpose: 'Pune family car linked to the same mobile as the rider profile',
    violations: [
      {
        date: '2026-02-16',
        type: 'Wrong Parking',
  ...
  KA02QT2026: {
    ...
    challanStatus: 'Clear',
    tpLoading: 0,
    purpose: 'Bengaluru EV scooter owned alongside a private car',
    violations: [
      {
        date: '2026-02-04',
        type: 'Wrong Parking',
