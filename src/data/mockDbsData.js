    ...
    insurance: {
      ...
      insurers: [
        ...
        },
        {
          ...
          logoUrl: '',
          brandColor: '#E2001A',
          tpPremium: 2465 + record.tpLoading,
          odFromPremium: 4150,
          premiumForCurrentDBS: 2465 + record.tpLoading,
          discountPercent: record.tpLoading === 0 ? 5 : 0,
          dbsParticipating: true,
          quoteUrl: 'https://example.com/quote/hdfcergo',
          rating: 4.6,
          reviews: 4210,
          features: ['10,000+ garages', 'Zero paperwork', 'Instant policy'],
        },
        {
          id: 'insurer-004',
          name: 'Tata AIG',
          logoUrl: '',
          brandColor: '#005B94',
          tpPremium: 2480 + record.tpLoading,
          odFromPremium: 4180,
          premiumForCurrentDBS: 2480 + record.tpLoading,
          discountPercent: record.tpLoading === 0 ? 4 : 0,
          dbsParticipating: true,
          quoteUrl: 'https://example.com/quote/tataaig',
          rating: 4.5,
          reviews: 3540,
          features: ['98% settlement', 'Engine protect', 'Key replacement'],
        },
        {
          id: 'insurer-005',
          name: 'Go Digit',
          logoUrl: '',
          brandColor: '#E5A500',
          tpPremium: 2420 + record.tpLoading,
          odFromPremium: 3990,
          premiumForCurrentDBS: 2420 + record.tpLoading,
          discountPercent: record.tpLoading === 0 ? 6 : 0,
          dbsParticipating: true,
          quoteUrl: 'https://example.com/quote/godigit',
          rating: 4.7,
          reviews: 5120,
          features: ['Self-inspection', '1-hr approval', 'Fast claim'],
        },
        {
          id: 'insurer-006',
          name: 'Bharti AXA',
        ...
        },
        {
          ...
          logoUrl: '',
          brandColor: '#C4161C',
          tpPremium: 2540 + record.tpLoading,
          odFromPremium: 4090,
          premiumForCurrentDBS: 2540 + record.tpLoading,
          discountPercent: 0,
          dbsParticipating: false,
          quoteUrl: 'https://example.com/quote/reliance',
          rating: 4.2,
          reviews: 1680,
          features: ['24/7 Roadside help', 'Free towing', 'Fast claim process'],
        },
      ],
      renewalHistory: [
        {
